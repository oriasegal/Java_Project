...
public class MP02Tests 
{
	@Test
	public void MP02TestWithSuperSampling() 
	{
		Scene scene = new Scene.SceneBuilder().setName("MP02 test with super sampling no threads and no adaptive super sampling")
				.setBackground(new Color(135,206,235)).build();
		...
		scene.geometries.add( 
			...
			Render render = new Render() 
					.setImageWriter(new ImageWriter("MP02WithSuperSampling", 500, 500)) 
					.setCamera(camera) 
	...
	@Test
	public void MP02TestWithSuperSamplingAndThreading() 
	{
		Scene scene = new Scene.SceneBuilder().setName("MP02 test with super sampling and threads no adaptive super sampling")
				.setBackground(new Color(135,206,235)).build();
		...
		scene.geometries.add( 
			...
			Render render = new Render() 
					.setImageWriter(new ImageWriter("MP02WithSuperSamplingAndThreading", 500, 500)) 
					.setCamera(camera) 
					.setRayTracer(new RayTracerBasic(scene));
	...
	@Test
	public void MP02TestWithSuperSamplingAndThreadingAndAdaptive() 
	{
		Scene scene = new Scene.SceneBuilder().setName("MP02 test with super sampling, threads and adaptive super sampling")
				.setBackground(new Color(135,206,235)).build();
		...
		scene.geometries.add( 
			...
			Render render = new Render() 
					.setImageWriter(new ImageWriter("MP02WithSuperSamplingAndThreadingAndAdaptive", 500, 500)) 
					.setCamera(camera) 
					.setRayTracer(new RayTracerBasic(scene));
			render.setMultithreading(3);
			render.setDebugPrint();
	...
	@Test
	public void MP02TestWithSuperSamplingAndAdaptive() 
	{
		Scene scene = new Scene.SceneBuilder().setName("MP02 test with super sampling and adaptive super sampling")
				.setBackground(new Color(135,206,235)).build();
		...
		scene.geometries.add( 
			...
			Render render = new Render() 
					.setImageWriter(new ImageWriter("MP02WithSuperSamplingAdaptive", 500, 500)) 
					.setCamera(camera) 
					.setRayTracer(new RayTracerBasic(scene));
			render.setDebugPrint();
			render.setAdaptiveSuperSampling(true);
