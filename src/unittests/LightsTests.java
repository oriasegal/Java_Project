...
{
	private Scene scene1 = new Scene.SceneBuilder().setName("Test scene").build();
	
	private Scene scene2 = new Scene.SceneBuilder().setName("Test scene") 
			.setAmbientLight(new AmbientLight(new Color(java.awt.Color.WHITE), 0.15)).build();
	...
	private static Geometry sphere = new Sphere(new Point3D(0, 0, -50), 50).setEmission(new Color(java.awt.Color.BLUE)) 
	...
	public void trianglesDirectional() {
		scene2.geometries.add(triangle1.setMaterial(new Material.MaterialBuilder().setKD(0.8).setKS(0.2).setNShininess(300).build()), 
				triangle2.setMaterial(new Material.MaterialBuilder().setKD(0.8).setKS(0.2).setNShininess(300).build()));
	...
	public void trianglesPoint() {
		scene2.geometries.add(triangle1.setMaterial(new Material.MaterialBuilder().setKD(0.5).setKS(0.5).setNShininess(300).build()), 
				triangle2.setMaterial(new Material.MaterialBuilder().setKD(0.5).setKS(0.5).setNShininess(300).build()));
	...
	public void sphereSpotSharp() {
		scene1.geometries.add(sphere);
		scene1.lights.add(new SpotLight(new Color(500, 300, 0), new Point3D(-50, -50, 50), new Vector(1, 1, -2), 1,
				0.000005, 0.00000025)); //last argument was 5
	...
	public void trianglesSpotSharp() {
		...
		scene2.lights.add(new SpotLight(new Color(800, 400, 400), new Point3D(10, -10, -130), new Vector(-2, -2, -1), 1,
				0.00005, 0.0000025)); //last argument was 5
