...
public class Polygon extends Geometry implements Intersectable
{
	...
	/**
	 * An override of the getNormal function for the Polygon class
	 * @author Dan
	 * @param point the starting point of the normal vector 
	...
	/**
	 * An override of the findIntsersections function for the Polygon class
	 * @author Hilla and Oria
	 * @param ray the ray we check all intersections with
	 * @return A list of all the intersection points found between the polygon and the sent ray
	 */
	@Override
